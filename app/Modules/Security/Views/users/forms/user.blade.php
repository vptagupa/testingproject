                    ...
                    <div class="row">
                        <div class="input-field col s4">
                            <select id="role" name="role">
                                ...
                                <option data-ng-repeat="row in roles" value="{% row.id %}">{% row.role %}</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="input-field col s4">
                            <select name="position" id="position">
                              ...
                              <option data-ng-repeat="row in positions" value="{% row.id %}">{% row.position %}</option>
                            </select>
                        ...
                        <div class="input-field col s4">
                            <select name="department" id="departments">
                              ...
                              <option data-ng-repeat="row in department" value="{% row.id %}">{% row.department %}</option>
                            </select>
                        ...
                        <div class="input-field col s4">
                            <select name="level" id="level">
                             ...
                             <option data-ng-repeat="row in levels" value="{% row.id %}">{% row.level %}</option>
                            </select>
