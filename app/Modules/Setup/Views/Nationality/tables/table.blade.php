...
<table class="table table-striped table-hover table_scroll">
    ...
    @foreach ($table as $row)
        <tr data-id="{{ encode($row->index_id) }}"  data-status="{{ $row->is_inactive }}" class="without-bg">
            ...
            <td><?= $row->is_default ? "<span class='label label-success label-round'><i class='fa fa-check' ></i></span>" : "<span class='label label-default label-round'><i class='fa fa-check'></i></span>"; ?></td>
            <td><?= $row->is_foreign ? "<span class='label label-success label-round'><i class='fa fa-check' ></i></span>" : "<span class='label label-default label-round'><i class='fa fa-check'></i></span>"; ?></td>
