...
use App\Modules\Setup\Services\RoomTypeServiceProvider as Services;
use App\Modules\Setup\Models\RoomType as RoomTypeModel;
use Request;
use Response;
use Permission;
...
class RoomType extends Controller {
	...
	private $url = [ 'page' => 'setup/hotel/room-type/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.RoomType.';
