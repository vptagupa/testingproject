...
use App\Modules\Setup\Services\BranchServiceProvider as Services;
use App\Modules\Setup\Models\Branch as BranchModel;
use Request;
use Response;
use Permission;
...
class Branch extends Controller {
	...
	private $url = [ 'page' => 'setup/branch/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.Branch.';
