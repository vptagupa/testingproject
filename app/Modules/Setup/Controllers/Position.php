...
use App\Modules\Setup\Services\PositionServiceProvider as Services;
use App\Modules\Setup\Models\Position as PositionModel;
use Request;
use Response;
use Permission;
...
class Position extends Controller{
	...
	private $url = [ 'page' => 'setup/position/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.Position.';
	...
	private function initializer()
	{
		...
		$this->permission = new Permission('position');
	}
}