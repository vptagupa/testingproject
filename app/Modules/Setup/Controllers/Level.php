...
use App\Modules\Setup\Services\LevelServiceProvider as Services;
use App\Modules\Setup\Models\Level as LevelModel;
use Request;
use Response;
use Permission;
...
class Level extends Controller{
	...
	private $url = [ 'page' => 'setup/level/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.Level.';
	...
	private function initializer()
	{
		...
		$this->permission = new Permission('level');
	}
}