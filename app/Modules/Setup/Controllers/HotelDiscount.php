...
use App\Modules\Setup\Services\HotelDiscountServiceProvider as Services;
use App\Modules\Setup\Models\HotelDiscount as HotelDiscountModel;
use Request;
use Response;
use Permission;

class HotelDiscount extends Controller {
	private $media =
		[
			'Title'=> 'Hotel Discount',
			'Description'=> 'Manage',
			'js'		=> ['crud'],
			'init'		=> ['CRUD.init()','FN.dataTable()','FN.datePicker()'],
			'plugin_js'	=> [
							'bootbox/bootbox.min',
	...
	private $url = [ 'page' => 'setup/hotel/discount/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.HotelDiscount.';
	...
	private function initializer()
	{
		...
		$this->model = new HotelDiscountModel;
		$this->permission = new Permission('room-discount');
	}
}