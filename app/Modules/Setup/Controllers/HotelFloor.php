...
use App\Modules\Setup\Services\HotelFloorServiceProvider as Services;
use App\Modules\Setup\Models\HotelFloor as HotelFloorModel;
use Request;
use Response;
use Permission;

class HotelFloor extends Controller {
	private $media =
		[
			'Title'=> 'HotelFloor',
			'Description'=> 'Manage',
	...
	private $url = [ 'page' => 'setup/hotel/floor/','form'=> '.form_crud' ];

	public $views = 'Setup.Views.HotelFloor.';
	...
	private function initializer()
	{
		...
		$this->model = new HotelFloorModel;
		$this->permission = new Permission('branch');
	}
}